...
namespace NLayer.Repository.Migrations
{
    ...
    {
        //Migration işlemi için öncellikle coonection string yazmalıyız bunuda API içindeki appsettings.Json içine yazıcaz.
        //bu Connection String kullanabilmesi için Ef.Core connection string bilgisini vermeliyim.
        //bu istemi söyle yapıcaz API içindeki program.Cs services Kısmında veriyoruz
        // Migration yapmadan önce Nugettan microsoft Entity framework.design  indirip sonra Migration işlemlerini yapıcaz.
        // Migration komutlarımız ise sırasıyla Add-Migration Name  Update-Database dir
